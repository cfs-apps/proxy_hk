...
#define HK_HK_TLM_MID         CFE_PLATFORM_CMD_TOPICID_TO_MID(HkTlmTopicId)
#define HK_COMBINED_PKT1_MID  CFE_PLATFORM_CMD_TOPICID_TO_MID(CombinedPkt1TlmTopicId)
#define HK_COMBINED_PKT2_MID  CFE_PLATFORM_CMD_TOPICID_TO_MID(CombinedPkt2TlmTopicId)
#define HK_COMBINED_PKT3_MID  CFE_PLATFORM_CMD_TOPICID_TO_MID(CombinedPkt3TlmTopicId)
#define HK_COMBINED_PKT4_MID  CFE_PLATFORM_CMD_TOPICID_TO_MID(CombinedPkt4TlmTopicId)
